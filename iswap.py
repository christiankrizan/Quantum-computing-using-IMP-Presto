...
from phase_calculator import bandsign, cap_at_plus_or_minus_two_pi
...
def iswap_tune_local_accumulated_phase(
    ...
    with pulsed.Pulsed(
        ...
        pls.setup_freq_lut(
            ...
            phases_q     = control_phase_arr + np.full_like(control_phase_arr, bandsign(control_freq_if_01_A))
        )
        pls.setup_freq_lut(
            output_ports = control_port_B,
            group        = 0,
        ...
        pls.setup_freq_lut(
            ...
            phases       = control_phase_arr,
            phases_q     = control_phase_arr + np.full_like(control_phase_arr, bandsign(control_freq_if_01_B))
        )
        ...
        for ii in range(num_phases):
            ...
            if prepare_input_state == '+0':
                ## TODO Convert to "actual" virtual-Z operations.
