...
def cz20_tune_total_phase_DEPRECATED(
    ip_address,
    ext_clk_present,
    ...
    ''' Prepare |+0> (or |0+>), run a CZ₂₀, and finally run a pi/2 pulse
...
def cz20_tune_total_phase_state_probability_DEPRECATED(
    ip_address,
    ext_clk_present,
...
def cz20_cross_ramsey_DEPRECATED(
    ip_address,
    ext_clk_present,
...
def cz20_cross_ramsey_state_probability_DEPRECATED(
    ip_address,
    ext_clk_present,
