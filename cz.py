...
def cz20_sweep_duration_and_detuning_state_probability_DEPRECATED(
    ip_address,
    ext_clk_present,
    ...
    assert 1 == 0, "Halted! This function is currently being modernised."
...
def cz20_Vz_ramsey_conditional_on_A_DEPRECATED(
    ip_address,
    ext_clk_present,
...
def cz20_Vz_ramsey_conditional_on_A_state_probability_DEPRECATED(
    ip_address,
    ext_clk_present,
...
def cz20_tune_local_accumulated_phase_DEPRECATED(
    ip_address,
    ext_clk_present,
...
def cz20_tune_local_accumulated_phase_state_probability_DEPRECATED(
    ip_address,
    ext_clk_present,
...
def cz20_tune_coupler_frequency_for_pi_phase_qb_B_is_control_DEPRECATED(
    ip_address,
    ext_clk_present,
...
def cz20_tune_coupler_frequency_for_pi_phase_qb_B_is_control_state_probability_DEPRECATED(
    ip_address,
    ext_clk_present,
