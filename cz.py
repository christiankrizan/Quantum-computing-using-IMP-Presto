...
def cz20_tune_local_accumulated_phase_state_probability(
    ...
    with pulsed.Pulsed(
        ...
        for ii in range(num_phases):
            ...
            # Apply virtual-Z
            add_virtual_z(T, phase_A, phase_adjustment_after_cz20_A + control_phase_arr[ii], control_port_A, 0, phases_declared, pls)
            add_virtual_z(T, phase_B, phase_adjustment_after_cz20_B + control_phase_arr[ii], control_port_B, 0, phases_declared, pls)
