...
def cz20_sweep_amplitude_and_detuning_for_t_half_state_probability(
    ...
    ''' Tune a CZ20-interaction between two qubits using
        ...
        multiple of 300 µs.
    '''
    assert 1 == 0, "HALTED! TODO This def is just a copy of the original, with nothing for state probability added."
    ## Input sanitisation
...
def cz20_sweep_amplitude_and_detuning_for_t_half_state_probability_DEPRECATED(
    ip_address,
    ext_clk_present,
