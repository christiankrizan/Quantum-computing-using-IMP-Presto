...
def t1_01_sweep_coupler_with_noise(
    ip_address,
    ext_clk_present,
    ...
    with pulsed.Pulsed(
        ...
        for ii in range(len(coupler_amp_arr)):
            ...
            for jj in range(len(delay_arr)):
                ...
                # Output the pi_01-pulse, as well as the noise pulse.
                pls.reset_phase(T, control_port)
    ...
    if not pls.dry_run:
        ...
        string_arr_to_return.append(save(
            ...
            source_code_of_executing_file = '', #get_sourcecode(__file__),
            default_exported_log_file_name = default_exported_log_file_name,
            append_to_log_name_before_timestamp = '_01_noise_added' + with_or_without_bias_string,
            append_to_log_name_after_timestamp  = '',
            select_resonator_for_single_log_export = '',
